...
export default function InventoryCard(props) {
    ...
    return (
        <Card sx={{ minWidth: 275 }}>
            <CardContent>
                <TextField value={inventory.find(inventory => inventory._id === props.id).item} className='tw-w-full' id="outlined-basic" name="inventoryName" label="Inventory Name" variant="outlined" disabled/>
