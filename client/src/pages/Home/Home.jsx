...
export default function Home() {
    ...
    const placeOrderHandler = () => {
        dispatch(kitchenActions.placeOrder({
        ...
        <div className='tw-grid tw-grid-cols-6'>
            ...
            <div className='tw-col-span-2 tw-bg-gray-200 tw-flex tw-flex-col tw-p-4 tw-gap-y-24'>
                <div className='tw-flex tw-flex-col tw-gap-y-4'>
                    <Typography variant='h4'>{cart.cartTotalQuantity === 0 ? "Nothing here, start adding products in the cart" : "Current Order"}</Typography>
                ...
                {cart.cartTotalQuantity > 0 &&
                    <div className=' tw-flex tw-flex-col tw-gap-y-8'>
                        ...
                        <TextField id="outlined-basic" label="Order Name" variant="outlined" value={cart.cartName} name='cartName' onChange={inputChangeHandler}/>
                        <Button className='tw-w-full' variant='contained' onClick={placeOrderHandler}>Place Order</Button>
                    </div>
                }
